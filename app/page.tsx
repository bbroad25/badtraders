...
export default function BadTradersLanding() {
  ...
  useEffect(() => {
    const initSDK = async () => {
      ...
      if (window.frame?.sdk) {
        ...
        console.warn("[MiniApp] frame.sdk not available")
      }
    }
  ...
  // --- Show fallback until SDK is ready ---
  if (!sdkReady) {
    return (
        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-4 border-b-4 border-primary">
          <div className="max-w-5xl w-full text-center space-y-8">
            <div className="space-y-4">
              <h1 className="text-7xl md:text-9xl font-bold text-primary uppercase tracking-tighter">
                $BADTRADERS
              </h1>
