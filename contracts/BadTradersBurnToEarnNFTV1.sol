...
/**
 * @title BadTradersBurnToEarnNFTV1
 * @notice ERC-721 NFT contract that requires burning BadTraders tokens to mint
 * @dev Version 1 of the Burn To Earn NFT series
 *
 * Version Specifications:
 * - V1: Burn 10M tokens to mint, Max Supply: 100 NFTs
 * - V2: Burn 25M tokens to mint, Max Supply: 900 NFTs (separate contract)
 *
 * Features:
...
contract BadTradersBurnToEarnNFTV1 is Initializable, ERC721Upgradeable, OwnableUpgradeable, UUPSUpgradeable, IERC4906, ReentrancyGuardUpgradeable {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return string(abi.encodePacked(
            ...
            _toString(tokenId),
            '","description":"BadTraders Burn To Earn NFT V1 minted by burning 10M tokens","image":"',
            imageUrl,
            '","attributes":[{"trait_type":"Type","value":"BadTraders Burn To Earn NFT V1"},{"trait_type":"Series","value":"V1"},{"trait_type":"Mint Number","value":',
            _toString(tokenId),
