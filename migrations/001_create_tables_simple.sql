-- Migration: Create tables for user registration and payouts (Simple version)
...
-- 2. Create daily_payouts table (with foreign key)
...
-- 3. Create trading_metrics table (with foreign key)
